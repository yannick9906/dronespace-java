...
public class DroneTransport extends Drone {
    public DroneTransport(int droneID, float maxHealth, float maxCargo, float maxEnergy, float baseWeight, float baseEnergyDraw, float damage, String name, iGUI gInterface) {
